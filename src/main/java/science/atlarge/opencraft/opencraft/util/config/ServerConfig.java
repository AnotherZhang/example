...
import static science.atlarge.opencraft.opencraft.util.config.ServerConfig.Validators.typeCheck;
...
public class ServerConfig implements DynamicallyTypedMap<ServerConfig.Key> {
    ...
    public enum Key {
        ...
        OPENCRAFT_CHUNK_POPULATION_FUNCTION("opencraft.chunk-population.function", "", String.class::isInstance),
        OPENCRAFT_CHUNK_POPULATION_PROVIDER("opencraft.chunk-population.provider", "azure", String.class::isInstance),
        OPENCRAFT_CHUNK_POPULATION_ENDPOINT("opencraft.chunk-population.endpoint", "", String.class::isInstance),

        // Storage Provider Setting
        OPENCRAFT_STORAGE_PROVIDER("opencraft.storage.provider", "default", String.class::isInstance),
        OPENCRAFT_STORAGE_SASTOKEN("opencraft.storage.sastoken", "", String.class::isInstance),
        OPENCRAFT_STORAGE_ENDPOINT("opencraft.storage.endpoint", "", String.class::isInstance),
        OPENCRAFT_STORAGE_CONTAINER("opencraft.storage.container", "", String.class::isInstance),
        OPENCRAFT_CACHEREGION_POLICY("opencraft.storage.cacheregionpolicy", "distance", String.class::isInstance),
        OPENCRAFT_CACHEREGION_DISTANCE("opencraft.storage.distance", 0, Integer.class::isInstance),

        // Serverless Ban
        OPENCRAFT_PLAYER_OPERATION_PROVIDER("opencraft.player-operation.provider", "default", String.class::isInstance),
        OPENCRAFT_PLAYER_OPERATION_ENDPOINT("opencraft.player-operation.endpoint", "", String.class::isInstance),

        // Serverless Environment Simulation
        OPENCRAFT_TIME_SIMULATION_PROVIDER("opencraft.time-simulation.provider", "default", String.class::isInstance),
        OPENCRAFT_TIME_SIMULATION_ENDPOINT("opencraft.time-simulation.endpoint", "", String.class::isInstance),
        OPENCRAFT_WEATHER_SIMULATION_PROVIDER("opencraft.weather-simulation.provider", "default", String.class::isInstance),
        OPENCRAFT_WEATHER_SIMULATION_ENDPOINT("opencraft.weather-simulation.endpoint", "", String.class::isInstance),
