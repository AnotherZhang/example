...
import science.atlarge.opencraft.opencraft.util.NibbleArray;
import science.atlarge.opencraft.opencraft.util.VariableValueArray;
...
public final class ChunkSection {
    ...
    /**
     * This method combines this chunk section with another chunk section.
     * <p>
     * Explanation of what this method is used for:
     * When chunk X is populated, it can also write data to adjacent chunks, say to chunk Y,
     * therefore initializing some blocks in Y. When serverless population for chunk Y completes,
     * we want to sync the data back into memory (i.e. by writing into Y's ChunkSection), but
     * that would mean overwriting the data that X already wrote into Y. This function combines the
     * data that X wrote into the sections of Y with the data that serverless population produces.
     *
     * @param types Type array of the other chunk section.
     */
