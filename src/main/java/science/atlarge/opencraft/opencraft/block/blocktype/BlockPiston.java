...
import science.atlarge.opencraft.opencraft.block.PistonMoveBehavior;
...
public class BlockPiston extends BlockDirectional {
    ...
    public void onRedstoneUpdate(GlowBlock me) {
        ...
        IntCoordinates2D chunkCoordinates = new IntCoordinates2D(chunk.getX(), chunk.getZ());
        ...
        if (me.isBlockIndirectlyPowered() && !isPistonExtended(me)) {
            ...
            world.getRawPlayers().stream().filter(player -> player.canSeeChunk(chunkCoordinates))
