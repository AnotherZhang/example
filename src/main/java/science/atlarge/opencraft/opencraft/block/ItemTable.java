...
import science.atlarge.opencraft.opencraft.block.blocktype.BlockBrewingStand;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockButton;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockCactus;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockCarpet;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockCarrot;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockCauldron;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockChest;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockChorusFlower;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockChorusPlant;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockCocoa;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockConcretePowder;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockCrops;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockDaylightDetector;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockDeadBush;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockDirectDrops;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockDirt;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockDispenser;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockDoor;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockDoublePlant;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockDoubleSlab;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockDropless;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockDropper;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockEnchantmentTable;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockEndRod;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockEnderChest;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockEnderPortalFrame;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockFalling;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockFence;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockFenceGate;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockFire;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockFlowerPot;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockFurnace;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockGrass;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockGrassPath;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockGravel;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockHay;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockHopper;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockHugeMushroom;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockIce;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockIronTrapDoor;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockJukebox;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockLadder;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockLamp;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockLava;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockLeaves;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockLever;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockLitRedstoneOre;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockLog;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockLog2;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockMagma;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockMelon;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockMobSpawner;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockMonsterEgg;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockMushroom;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockMycel;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockNeedsAttached;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockNetherWart;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockNote;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockObserver;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockOre;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockPiston;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockPortal;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockPotato;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockPumpkin;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockPumpkinBase;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockPurpurPillar;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockQuartz;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockRails;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockRandomDrops;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockRedstone;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockRedstoneComparator;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockRedstoneOre;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockRedstoneRepeater;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockRedstoneTorch;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockSapling;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockSign;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockSkull;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockSlab;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockSnow;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockSnowBlock;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockSoil;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockSponge;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockStairs;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockStem;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockStone;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockSugarCane;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockTallGrass;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockTnt;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockTorch;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockType;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockVine;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockWater;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockWeb;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockWoodenTrapDoor;
import science.atlarge.opencraft.opencraft.block.blocktype.BlockWorkbench;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemArmorStand;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemBanner;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemBoat;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemBow;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemBucket;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemChorusFruit;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemDye;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemEgg;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemEndCrystal;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemEnderPearl;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemExperienceBottle;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemFilledBucket;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemFirework;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemFishCooked;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemFishRaw;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemFishingRod;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemFlintAndSteel;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemFood;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemFoodSeeds;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemGoldenApple;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemHoe;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemItemFrame;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemKnowledgeBook;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemMilk;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemMinecart;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemPainting;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemPlaceAs;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemPoisonousPotato;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemRawChicken;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemRottenFlesh;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemSeeds;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemShovel;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemSign;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemSnowball;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemSoup;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemSpawn;
import science.atlarge.opencraft.opencraft.block.itemtype.ItemSpiderEye;
